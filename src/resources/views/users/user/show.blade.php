...
<div class="card w-100 mb-4">
    ...
    <div class="overflow-auto m-3" style="max-height: 400px;">
        ...
        <img src="{{ asset('/storage/' . $foto->ftphn) }}" class="img-thumbnail d-inline-flex" alt="fotorth" width="30%">
        @elseif($fileExtension === 'pdf')
        <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/storage/' . $foto->ftphn) }}" class="btn-success btn"><i class="bi bi-file-earmark-pdf-fill"></i>Lihat Pdf {{$index}}</button>
        @php
        $index = $index + 1;
        @endphp
        @endif
        ...
        @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
        <img src="{{ asset('/storage/' . $data->ftktp) }}" class="img-thumbnail d-inline-flex" alt="ftktp" width="30%">
        @elseif($fileExtension === 'pdf')
        <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/storage/' . $data->ftktp) }}" class="btn-success btn"><i class="bi bi-file-earmark-pdf-fill"></i>Lihat Pdf</button>
        @endif
        @endif
        ...
        @php
        $fileExtension = pathinfo(asset('/storage/' . $surat->srtrth), PATHINFO_EXTENSION);
        @endphp
        @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
        <img src="{{ asset('/storage/' . $surat->srtrth) }}" class="img-thumbnail d-inline-flex" id="surat" alt="surat" width="30%">
        @elseif($fileExtension === 'pdf')
        <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/storage/' . $surat->srtrth) }}" class="btn-success btn" id="pdfreadersurat"><i class="bi bi-file-earmark-pdf-fill"></i>Lihat Pdf {{$index}}</button>
        @php
        $index = $index + 1;
        @endphp
        @endif
        ...
        @endphp
        @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
        <img src="{{ asset('/storage/' . $lmrec->lmrec) }}" class="img-thumbnail d-inline-flex" alt="lmrec" width="30%">
        @elseif($fileExtension === 'pdf')
        <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/storage/' . $lmrec->lmrec) }}" class="btn-success btn"><i class="bi bi-file-earmark-pdf-fill"></i>Lihat Pdf {{$index}}</button>
        @php
        $index = $index + 1;
        @endphp
        @endif
        ...
        @php
        $fileExtension = pathinfo(asset('/storage/' . $survei->ftphn), PATHINFO_EXTENSION);
        @endphp
        @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
        <img src="{{ asset('/storage/' . $survei->ftphn) }}" class="img-thumbnail d-inline-flex" alt="survei" width="30%">
        @elseif($fileExtension === 'pdf')
        <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/storage/' . $survei->ftphn) }}" class="btn-success btn"><i class="bi bi-file-earmark-pdf-fill"></i>Lihat Pdf {{$index}}</button>
        @php
        $index = $index + 1;
        @endphp
        @endif
        ...
        @php
        $fileExtension = pathinfo(asset('/storage/' . $pelaksana->ftplksn), PATHINFO_EXTENSION);
        @endphp
        @if(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg', 'webp']))
        <img src="{{ asset('/storage/' . $pelaksana->ftplksn) }}" class="img-thumbnail d-inline-flex" alt="pelaksana" width="30%">
        @elseif($fileExtension === 'pdf')
        <button data-bs-toggle="modal" data-bs-target="#pdfModal" data-pdf="{{ asset('/storage/' . $pelaksana->ftplksn) }}" class="btn-success btn"><i class="bi bi-file-earmark-pdf-fill"></i>Lihat Pdf {{$index}}</button>
        @php
        $index = $index + 1;
        @endphp
        @endif
